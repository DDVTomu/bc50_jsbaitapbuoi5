...
function tongDien(watt) {
  ...
  let tong = 0;
  if (watt <= 0) {
    document.getElementById("b2Result").style =
      "background-color: #ffbbbb; color: red;border: 1px solid red;border-radius: 5px;padding: 10px; margin-bottom: 10px;";
    document.getElementById("b2Result").innerHTML =
...
function tienDien() {
  const Watt = document.getElementById("B2Watt-input").value * 1;
  const TenKH = document.getElementById("B2name-input").value;
...
function tienThue() {
  const ten = document.getElementById("B3name-input").value;
  const thuNhap = document.getElementById("B3thunhap-input").value * 1;
  const nguoiPT = document.getElementById("B3songuoi-input").value;
  const VND = new Intl.NumberFormat("vn-VN", {
    style: "currency",
    currency: "VND",
  });
  ...
  if (thuNhap <= 0) {
    document.getElementById("b3Result").style =
      "background-color: #ffbbbb; color: red;border: 1px solid red;border-radius: 5px;padding: 10px; margin-bottom: 10px;";
    document.getElementById("b3Result").innerHTML = "Xin nhập số tiền thu nhập";
  } else {
    ...
    document.getElementById("b3Result").style =
      "background-color: #bbffbb;color: green;border: 1px solid green;border-radius: 5px;padding: 10px;margin-bottom: 10px;";
    document.getElementById("b3Result").innerHTML =
      "Khách hàng tên: " +
      ten +
      "- Tiền thu nhập: " +
      thuNhap +
